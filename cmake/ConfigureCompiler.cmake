...
set(USE_LIBFUZZER OFF CACHE BOOL "Compile with libfuzzer")
...
if(WIN32)
  ...
  if(USE_LIBFUZZER)
    add_compile_options(
      -fsanitize=fuzzer)
    set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} -fsanitize=fuzzer")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -fsanitize=fuzzer")
    set(CMAKE_EXE_LINKER_FLAGS    "${CMAKE_EXE_LINKER_FLAGS}    -fsanitize=fuzzer ${CMAKE_THREAD_LIBS_INIT}")
  endif()
